...
@unittest.skipIf(not TEST_PAWNS, 'Those tests are temporarily disabled')
...
@unittest.skipIf(not TEST_KNIGHTS, 'Those tests are temporarily disabled')
...
@unittest.skipIf(not TEST_QUEENS, 'Those tests are temporarily disabled')
...
@unittest.skipIf(not TEST_KINGS, 'Those tests are temporarily disabled')
...
@unittest.skipIf(not TEST_ROOKS, 'Those tests are temporarily disabled')
...
@unittest.skipIf(not TEST_BISHOPS, 'Those tests are temporarily disabled')
...
@unittest.skipIf(not TEST_BOARD_SETUP, 'Those tests are temporarily disabled')
...
@unittest.skipIf(not TEST_BOARD_LISTING_MOVES, 'Those tests are temporarily disabled')
...
@unittest.skipIf(not TEST_BOARD_MOVING, 'Those tests are temporarily disabled')
...
@unittest.skipIf(not TEST_PAWNS_KILLING_THE_ENEMY, 'Those tests are temporarily disabled')
...
@unittest.skipIf(not TEST_ROOKS_KILLING_THE_ENEMY, 'Those tests are temporarily disabled')
...
@unittest.skipIf(not TEST_KNIGHTS_KILLING_THE_ENEMY, 'Those tests are temporarily disabled')
...
@unittest.skipIf(not TEST_BISHOPS_KILLING_THE_ENEMY, 'Those tests are temporarily disabled')
...
@unittest.skipIf(not TEST_KINGS_KILLING_THE_ENEMY, 'Those tests are temporarily disabled')
...
@unittest.skipIf(not TEST_QUEENS_KILLING_THE_ENEMY, 'Those tests are temporarily disabled')
...
@unittest.skipIf(not TEST_PAWNS_NOT_KILLING_ALLIES, 'Those tests are temporarily disabled')
...
@unittest.skipIf(not TEST_ROOKS_NOT_KILLING_ALLIES, 'Those tests are temporarily disabled')
...
@unittest.skipIf(not TEST_KNIGHTS_NOT_KILLING_ALLIES, 'Those tests are temporarily disabled')
...
@unittest.skipIf(not TEST_BISHOPS_NOT_KILLING_ALLIES, 'Those tests are temporarily disabled')
...
@unittest.skipIf(not TEST_KINGS_NOT_KILLING_ALLIES, 'Those tests are temporarily disabled')
...
@unittest.skipIf(not TEST_QUEENS_NOT_KILLING_ALLIES, 'Those tests are temporarily disabled')
...
@unittest.skipIf(not TEST_GAME_END, 'Those tests are temporarily disabled')
